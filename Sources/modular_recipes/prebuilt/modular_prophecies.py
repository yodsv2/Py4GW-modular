...
PROPHECIES_PHASE_SPECS: list[tuple[str, str, str, str]] = [
    ...
    ('Crystal Desert', 'mission', 'prophecies/dunes_of_despair', 'Dunes of Despair'),
    ('Crystal Desert', 'mission', 'prophecies/thirsty_river', 'Thirsty River'),
    ('Crystal Desert', 'mission', 'prophecies/elona_reach', 'Elona Reach'),
    ('Crystal Desert', 'mission', 'prophecies/augury_rock', 'Augury Rock'),
    ('Crystal Desert', 'mission', 'prophecies/the_dragons_lair', "The Dragon's Lair"),
