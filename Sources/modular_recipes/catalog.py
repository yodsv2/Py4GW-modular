...
RECIPE_MODULES: tuple[str, ...] = (
    ...
    'Sources.modular_recipes.missions.eotn.charr_homelands',
    'Sources.modular_recipes.missions.eotn.depths_of_tyria',
    'Sources.modular_recipes.missions.eotn.far_shiverpeaks',
    'Sources.modular_recipes.missions.eotn.tarnished_coast',
    ...
    'Sources.modular_recipes.quests.eotn.story',
