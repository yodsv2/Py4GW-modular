...
NPC_TARGETS: dict[str, AgentTargetValue] = {
    ...
    "FIRST_SPEAR_JAHDUGAR": (
        (
            (1, 129, 14, 61, 125, 184, 51, 203, 66, 88, 0, 0),
            (1, 129, 250, 60, 138, 201, 197, 203, 129, 111, 0, 0),
        ),
        "First Spear Jahdugar",
    ),
    "FIRSTWATCH_SERGIO_SKILLS": (((246, 48, 12, 192, 32, 172, 194, 87, 0, 0),), "Firstwatch Sergio [Skills]"),
    "JIAJU_TAI": (((238, 48, 133, 158, 230, 233, 215, 47, 0, 0),), "Jiaju Tai"),
    ...
    "RAFIKI_EXPERT_NECROMANCER": (
        ((1, 129, 50, 55, 78, 175, 117, 200, 27, 8, 0, 0),),
        "Rafiki [Expert Necromancer]",
    ),
    ...
    "KORMIR": (
        (
            ...
            (1, 129, 100, 50, 109, 131, 195, 146, 49, 123, 0, 0),
            (1, 129, 126, 61, 72, 165, 95, 227, 251, 120, 0, 0),
        ),
        "Kormir",
    ),
    "NPC_10": (((1, 129, 100, 50, 109, 131, 195, 146, 49, 123, 0, 0),), "Npc 10"),
    ...
    "DOCKHAND_QUANGNAI": (((209, 94, 221, 216, 120, 222, 14, 28, 0, 0),), "Dockhand Quangnai"),
    ...
    "PELEI": (((1, 129, 80, 32, 116, 161, 193, 148, 219, 20, 0, 0),), "Pelei"),
    ...
    "SUNSPEAR_SCOUT": (
        (
            (1, 129, 192, 71, 144, 187, 17, 211, 164, 104, 0, 0),
            (1, 129, 200, 71, 27, 213, 71, 146, 235, 104, 0, 0),
        ),
        "Sunspear Scout",
    ),
    "SUNSPEAR_RECRUIT": (
        ((1, 129, 35, 56, 187, 201, 162, 143, 235, 86, 0, 0),),
        "Sunspear Recruit",
    ),
    ...
    "KAHLIM_MATERIAL_TRADER": (((1, 129, 88, 32, 99, 210, 77, 201, 205, 48, 0, 0),), "Kahlim [Material Trader]"),
    ...
    "MHENLO": (
        (
            (1, 129, 26, 79, 235, 179, 80, 160, 65, 54, 0, 0),
            (1, 129, 214, 1, 59, 135, 232, 160, 206, 96, 0, 0),
        ),
        "Mhenlo",
    ),
    "BROTHER_MHENLO": (
        (
            (1, 129, 26, 79, 235, 179, 80, 160, 65, 54, 0, 0),
            (227, 94, 97, 170, 251, 152, 84, 117, 0, 0),
        ),
        "Brother Mhenlo",
    ),
    "GUARDSMAN_CHOW": (((137, 95, 82, 197, 120, 149, 170, 37, 0, 0),), "Guardsman Chow"),
    "GUARDSMAN_CHOW_OUTPOST": AgentTargetDefinition(display_name="Guardsman Chow"),
    "KAHDASH": (((1, 129, 59, 38, 11, 228, 142, 158, 239, 35, 0, 0),), "Kahdash"),
    ...
    "XUNLAI_AGENT_JUEH": (((1, 129, 169, 37, 91, 190, 77, 148, 127, 82, 0, 0),), "Xunlai Agent Jueh"),
    "XUNLAI_AGENT_STORAGE": (((1, 129, 32, 31, 123, 173, 243, 229, 154, 16, 0, 0),), "Xunlai Agent [Storage]"),
    ...
    "BARTHOLOS": (((1, 129, 63, 120, 44, 154, 238, 254, 238, 96, 0, 0),), "Bartholos"),
    "BEAR_SPIRIT": (((1, 129, 93, 117, 245, 241, 85, 239, 242, 43, 0, 0),), "Bear Spirit"),
    "BLIMM": (((1, 129, 140, 119, 199, 199, 202, 150, 118, 109, 0, 0),), "Blimm"),
    "BONWOR_FIERCEBLADE": (
        ((1, 129, 160, 119, 151, 219, 219, 163, 219, 124, 0, 0),),
        "Bonwor Fierceblade",
    ),
    "BUDGER_BLACKPOWDER": (((2, 129, 82, 15, 65, 253, 212, 199, 220, 67, 0, 0),), "Budger Blackpowder"),
    "CAPTAIN_LANGMAR": (((2, 129, 142, 5, 6, 188, 196, 140, 246, 83, 0, 0),), "Captain Langmar"),
    "CEMBRIEN": AgentTargetDefinition(display_name="Cembrien"),
    "CREVASSE": AgentTargetDefinition(display_name="Crevasse"),
    "DROKNAR": (((2, 129, 217, 42, 7, 145, 117, 252, 177, 81, 0, 0),), "Droknar"),
    "EGIL_FIRETELLER": (((1, 129, 161, 121, 103, 209, 54, 232, 217, 65, 0, 0),), "Egil Fireteller"),
    "EXPERIMENT_KREWE_MEMBER": (
        ((2, 129, 82, 36, 241, 140, 35, 228, 139, 29, 0, 0),),
        "Experiment Krewe Member",
    ),
    "GADD": (((1, 129, 138, 119, 204, 209, 125, 180, 145, 21, 0, 0),), "Gadd"),
    "GRON_FIERCECLAW": (((1, 129, 243, 117, 56, 210, 165, 197, 226, 49, 0, 0),), "Gron Fierceclaw"),
    "GRON_FIERCECLAW_MERCHANT": (
        ((2, 129, 202, 30, 157, 212, 25, 239, 23, 78, 0, 0),),
        "Gron Fierceclaw [Merchant]",
    ),
    "GUNNAR_POUNDFIST": (
        ((1, 129, 162, 121, 69, 176, 106, 184, 152, 63, 0, 0),),
        "Gunnar Poundfist",
    ),
    "G_O_L_E_M_2_0_DEFENSE": (
        ((2, 129, 33, 18, 173, 155, 167, 156, 155, 26, 0, 0),),
        "G.O.L.E.M. 2.0 [Defense]",
    ),
    "G_O_L_E_M_2_0_MELEE": (
        ((2, 129, 32, 18, 207, 221, 110, 255, 129, 96, 0, 0),),
        "G.O.L.E.M. 2.0 [Melee]",
    ),
    "G_O_L_E_M_2_0_RANGED": (
        ((2, 129, 34, 18, 224, 221, 93, 240, 254, 89, 0, 0),),
        "G.O.L.E.M. 2.0 [Ranged]",
    ),
    "HIGH_PRIEST_ALKAR": (((2, 129, 154, 15, 132, 248, 42, 129, 38, 121, 0, 0),), "High Priest Alkar"),
    "INSCRIPTION_STONE": (((1, 129, 58, 120, 70, 137, 168, 229, 175, 4, 0, 0),), "Inscription Stone"),
    "JALIS_IRONHAMMER": (((2, 129, 48, 33, 165, 206, 87, 172, 244, 50, 0, 0),), "Jalis Ironhammer"),
    "JORA": (((2, 129, 15, 32, 0, 0),), "Jora"),
    "LEFT_SIEGE_DEVOURER": (((1, 129, 127, 123, 177, 244, 171, 236, 26, 60, 0, 0),), "Left Siege Devourer"),
    "LEN_CALDORON": AgentTargetDefinition(display_name="Len Caldoron"),
    "LIVIA": (((1, 129, 176, 119, 0, 0),), "Livia"),
    "LORK": (((1, 129, 137, 119, 220, 161, 173, 189, 227, 11, 0, 0),), "Lork"),
    "MACHINE_KREWE_MEMBER": (
        ((2, 129, 105, 36, 58, 154, 77, 237, 194, 17, 0, 0),),
        "Machine Krewe Member",
    ),
    "MAMP": (((1, 129, 136, 120, 148, 218, 33, 252, 212, 109, 0, 0),), "Mamp"),
    "OLAF_OLAFSON": (((1, 129, 170, 121, 78, 244, 95, 194, 137, 42, 0, 0),), "Olaf Olafson"),
    "OLFUN_LONGEYE": (((1, 129, 141, 118, 239, 144, 85, 230, 74, 13, 0, 0),), "Olfun Longeye"),
    "OLRUN_OLAFDOTTIR": (((1, 129, 164, 121, 225, 164, 220, 131, 89, 67, 0, 0),), "Olrun Olafdottir"),
    "PLAXX": (((1, 129, 212, 120, 136, 255, 82, 220, 33, 121, 0, 0),), "Plaxx"),
    "PYRE_FIERCESHOT": (((2, 129, 83, 6, 0, 0),), "Pyre Fierceshot"),
    "RENK": (((2, 129, 45, 30, 69, 132, 178, 170, 150, 96, 0, 0),), "Renk"),
    "RIGHT_SIEGE_DEVOURER": (((1, 129, 128, 123, 93, 201, 78, 153, 137, 34, 0, 0),), "Right Siege Devourer"),
    "ROAN_FIERCEHEART": (((1, 129, 245, 118, 226, 215, 156, 187, 74, 40, 0, 0),), "Roan Fierceheart"),
    "SEER_FIERCEREIGN": (((1, 129, 126, 117, 158, 196, 18, 233, 228, 110, 0, 0),), "Seer Fiercereign"),
    "SHRINE_OF_THE_BEAR_SPIRIT": (
        ((1, 129, 15, 123, 35, 214, 92, 191, 207, 49, 0, 0),),
    ...
    "SIF_SHADOWHUNTER": (
        ((1, 129, 108, 118, 51, 223, 120, 142, 210, 43, 0, 0),),
        "Sif Shadowhunter",
    ),
    "SILISS_YASSITH": AgentTargetDefinition(display_name="Siliss Yassith"),
    "SKY_KREWE_MEMBER": (((2, 129, 13, 36, 240, 254, 26, 196, 25, 22, 0, 0),), "Sky Krewe Member"),
    "SOKKA": (((1, 129, 143, 119, 136, 221, 14, 145, 28, 111, 0, 0),), "Sokka"),
    "VANGUARD_HELMET": (((1, 129, 142, 118, 96, 189, 132, 211, 196, 46, 0, 0),), "Vanguard Helmet"),
    "WORKER_GOLEM": (
        (
            (2, 129, 98, 6, 148, 166, 4, 178, 195, 75, 0, 0),
            (2, 129, 102, 6, 172, 208, 236, 211, 18, 15, 0, 0),
        ),
        "Worker Golem",
    ),
...
ENEMY_TARGETS: dict[str, AgentTargetValue] = {
    ...
    "APOCRYPHA": (((1, 129, 62, 38, 181, 195, 129, 192, 20, 36, 0, 0),), "Apocrypha"),
    "ARMORED_SAURUS": (((1, 129, 89, 123, 237, 143, 104, 235, 46, 90, 0, 0),), "Armored Saurus"),
    "ASURA_UNDERGATE": AgentTargetDefinition(display_name="Asura Undergate"),
    "CHARR_PRISON_GUARD": (
        ((1, 129, 192, 118, 217, 154, 131, 132, 250, 118, 0, 0),),
        "Charr Prison Guard",
    ),
    "CYNDR_THE_MOUNTAIN_HEART": (
        ((1, 129, 131, 122, 254, 204, 119, 207, 107, 109, 0, 0),),
        "Cyndr the Mountain Heart",
    ),
    "DAREHK_THE_QUICK": (((1, 129, 48, 38, 153, 246, 183, 137, 215, 17, 0, 0),), "Darehk the Quick"),
    "INDESTRUCTIBLE_GOLEM": (
        ((1, 129, 172, 119, 165, 164, 53, 150, 49, 101, 0, 0),),
        "Indestructible Golem",
    ),
    "INSCRIBED_ETTIN": (
        (
            (2, 129, 168, 20, 209, 219, 178, 245, 70, 108, 0, 0),
            (2, 129, 170, 20, 11, 130, 101, 169, 34, 72, 0, 0),
        ),
        "Inscribed Ettin",
    ),
    "INSCRIBED_GUARDIAN": (
        ((1, 129, 66, 120, 83, 130, 234, 186, 134, 76, 0, 0),),
        "Inscribed Guardian",
    ),
    "INSCRIBED_SENTRY": (
        (
            (1, 129, 64, 120, 106, 239, 230, 200, 148, 7, 0, 0),
            (1, 129, 65, 120, 229, 145, 136, 149, 182, 42, 0, 0),
        ),
        "Inscribed Sentry",
    ),
    "THE_GREAT_DESTROYER": (
        ((1, 129, 226, 122, 88, 220, 14, 225, 229, 112, 0, 0),),
        "The Great Destroyer",
    ),
...
GADGET_TARGETS: dict[str, AgentTargetValue] = {
    ...
    "STONE_PEDESTAL": (((1, 129, 78, 38, 29, 168, 19, 239, 148, 1, 0, 0),), "Stone Pedestal"),
    "CHARR_PRISON_LOCK": (((1, 129, 84, 118, 27, 140, 13, 152, 233, 70, 0, 0),), "Charr Prison Lock"),
    "GOLEM_DISABLING_LEVER": (
        ((1, 129, 2, 120, 235, 130, 3, 248, 86, 61, 0, 0),),
        "Golem Disabling Lever",
    ),
    "INSCRIPTION_STONE": (((1, 129, 58, 120, 70, 137, 168, 229, 175, 4, 0, 0),), "Inscription Stone"),
    "MOUNTAIN_HEART_CHEST": (
        ((2, 129, 92, 40, 195, 150, 57, 179, 144, 85, 0, 0),),
        "Mountain Heart Chest",
    ),
    "MYSTICAL_KEYHOLDER": (
        ((1, 129, 8, 120, 159, 248, 121, 134, 32, 3, 0, 0),),
        "Mystical Keyholder",
    ),
    "UNSTABLE_MAGICAL_ENERGY_STORAGE": (
        ((1, 129, 5, 120, 118, 189, 103, 146, 221, 121, 0, 0),),
